...
<a href="ViewTh.jsp">Movie Theaters</a><br>
<a href="#">Shopping Malls</a><br>
<a href="#">Temples</a><br>
<a href="ViewIndus.jsp">COMPANIES</a>
</fieldset>
</div></td>
<td>
<table align="center" border='1'><tr><th>Theater</th><th>MovieName</th><th>Address&Contact</th></tr>
<%
...
System.out.println(str);
	try
	{
		...
		{	
				...
				%><tr><td><%=rs.getString(1)%></td><td><%=rs.getString(2)%></td><td><%=rs.getString(3)%></td><td>	
					<%
