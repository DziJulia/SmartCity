...
<body>
<table border='1'><tr><td>BusNo</td><td>Source</td><td>Destination</td><td>Time</td></tr>
<%	 
		 ...
		 try
			{
				...
				while(rs.next())
				{
					...
					{
								%><tr><td><%=rs.getString(1)%></td><td><%=rs.getString(2)%></td><td><%=rs.getString(3)%></td><td><%=rs.getString(4)%></td><td>
