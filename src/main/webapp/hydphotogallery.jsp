         ...
         <table width="100%" border="0" cellspacing="6" cellpadding="0">
          <tr> 
          		...
          		<td width="93%" class=descText align="left" valign="top"> 
					...
					<tr> 
						<td> 
							<a href="javascript:OpenFrame(0)" class=dd>
							<img src="./Images/vizaghistory_img.jpg" width="110" height="53" BORDER="0"></a>
						</td>
						<td> 
							<a href="javascript:OpenFrame(1)" class=dd>
							<img src="./Images/12-Vizaga2z-Vizag Port.jpg" width="110" height="53" BORDER="0"></a>
						</td>
						<td> 
							<a href="javascript:OpenFrame(2)" class=dd>
							<img src="./Images/kailasagiri-visakhapatnam.jpg" width="110" height="53" BORDER="0"></a>
						</td>
						<td> 
							<a href="javascript:OpenFrame(3)" class=dd>
							<img src="./Images/Vizag old.jpg" width="110" height="53" BORDER="0"></a>
						</td>
					</tr> 
		</table>
...
<div align="center"></div><table width="100%" border="0" cellspacing="6" cellpadding="0"> 
<tr>
	 <td width="6%">&nbsp;</td><td width="93%" class=descText align="left" valign="top"> 
		<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
		<tr>
			 <td> 
					<a href="javascript:OpenFrame(4)" class=dd>
					<img src="./Images/meccaSmall.gif" width="110" height="53" BORDER="0"></a></td><td> 
					<a href="javascript:OpenFrame(5)" class=dd>
					<img src="./Images/gandipetSmall.gif" width="110" height="53" BORDER="0"></a></td><td> 
					<a href="javascript:OpenFrame(6)" class=dd>
					<img src="./Images/charminarSmall.gif" width="110" height="53" BORDER="0"></a></td><td> 
					<a href="javascript:OpenFrame(7)" class=dd>
					<img src="./Images/hussainsagarSmall.gif" width="110" height="53" BORDER="0"></a></td></tr> 
		</table> 
        <table width="100%" border="0" cellspacing="4" cellpadding="0"> 
               <tr valign="middle"> 
                    <td align="center" width="11%"><font size="1" face="Verdana"><b><font color="#808040" face="Verdana, Arial, Helvetica, sans-serif"> 
                     <a href="javascript:OpenFrame(4)" class=dd>Mecca Masjid</a></font></b></font></td> 
                    ...
                    <td width="25%" align="center"><div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#808040"> 
                     <a href="javascript:OpenFrame(7)" class=dd>Hussain Sagar</a></font></b></font></div></td> 
                </tr> 
        </table>
        </td>
...
<div class="sidenav">
		...
		<legend>Login</legend>
			<form method="post"  action="open_Home.jsp" name="form1" onSubmit="return check1()">
				...
				<tr>
					...
					<tr><td align="center"><a href="fg.jsp">Forget Password?</a></td>
	...
	<table width="300">
	<tr><td><marquee direction="up" scrolldelay="250" onmouseover="wait()">
		<div style="color:purple;font-size:large;font-style:italic;">Events@VIZAG On 05-03-2010 <br>Food Festival @ 
		<img src="Images\dolphin_hotel_logo.jpg"/ alt="Dolphin Hotel"></div></marquee></td></tr></table>
	</td></table>
		<img src="Images\rgt_sep.jpg"><img src="Images\rgt_sep.jpg"><img src="Images\rgt_sep.jpg"><img src="Images\rgt_sep.jpg">     
